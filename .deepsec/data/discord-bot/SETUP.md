# Agent setup for `discord-bot`

This is a deepsec scanning workspace. Project `discord-bot` was just registered
(target: `..`). Setup is incomplete — `data/discord-bot/INFO.md`
...
2. **Fill in `data/discord-bot/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id discord-bot
pnpm deepsec process --project-id discord-bot
```
